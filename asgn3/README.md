...
* queue.h the header file for the queue that you are implementing.

* rwlock.h the header file for the reader-writer lock that you are implementing.

* load_repo.sh a script that can be used to load your asgn3 for testing.
...
```
cp queue.h {path_to_asg3_dir}
cp rwlock.h {path_to_asg3_dir}
...
3. Make your queue.o/rwlock.o binaries:
